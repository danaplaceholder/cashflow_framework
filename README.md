...
# TODOs:
- caching... Existing cache layer logic is unused
- Metaclasses to enforce quality control on user-created child classes of the BaseNode and BaseDataElement classes
- ...
